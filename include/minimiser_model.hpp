...
void do_cerealisation_out(std::vector<size_t> const & vec, cmd_arguments const & args)
{
    std::filesystem::path filename = args.ibf_file.parent_path() / ("binary_p" +
                                                                           std::to_string(args.pattern_size) +
...
bool do_cerealisation_in(std::vector<size_t> & vec, cmd_arguments const & args)
{
    std::filesystem::path filename = args.ibf_file.parent_path() / ("binary_p" +
                                                                           std::to_string(args.pattern_size) +
                                                                    "_w" + std::to_string(args.window_size) +
